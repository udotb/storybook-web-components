const templateTimePicker = document.createElement('template');
templateTimePicker.innerHTML = `
<style>
  input {
    width: 100%;
    padding: 9px 20px;
...
export class TimePicker extends HTMLElement {
  constructor() {
    ...
    this.shadowRoot.appendChild(templateTimePicker.content.cloneNode(true));
  }
