const inputFieldTemplate = document.createElement('template');
inputFieldTemplate.innerHTML = `
...
class InputField extends HTMLElement {
    ...
    constructor() {
        ...
        this.shadowRoot.appendChild(inputFieldTemplate.content.cloneNode(true));
    }
    ...
    static get observedAttributes() {
        return ['placeholder', 'background-color', 'text-color', 'class', 'focused', 'font-size','value'];
    }
