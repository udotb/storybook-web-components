import '../../jsys/types/email-address';
...
export class EmailAddressInput extends HTMLElement {
    constructor() {
        super();
    ...
    verify(value) {
        ...
        try {
            let email = new EmailAddress(value);
            this.setAttribute('valid', 'true');
        } catch (e) {
            this.shadowRoot.getElementById("wrong-format").innerHTML = e;
            this.shadowRoot.getElementById("require").innerHTML = null;
            this.setAttribute('valid', 'false');
            return false;
        }
...
window.customElements.define('email-address', EmailAddressInput);
