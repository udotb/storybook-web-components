const reviewStarsTemplate = document.createElement('template');
reviewStarsTemplate.innerHTML = `
...
<div class="float-left">
    <div class="review">
          ...
          <input type="radio" checked="checked" name="review" id="review-1">
...
class ReviewStars extends HTMLElement {
    ...
    constructor() {
        ...
        this.shadowRoot.appendChild(reviewStarsTemplate.content.cloneNode(true));
    }
...
window.customElements.define('review-stars', ReviewStars);
