const specsFontIconTemplate = document.createElement('template');
specsFontIconTemplate.innerHTML = `
...
class SpecsFontIcon extends HTMLElement {

    constructor() {
        super();
        this.attachShadow({mode: 'open'});
        this.shadowRoot.appendChild(specsFontIconTemplate.content.cloneNode(true));
    }
...
window.customElements.define('specs-font-icon', SpecsFontIcon);
export default SpecsFontIcon;
